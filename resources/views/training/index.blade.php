                    ...
                    @forelse($trainings as $training)  
                        ...
                        <tr class="pointer border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                            ...
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                <div
                                    class="badge  space-x-reverse space-x-2.5 text-secondary dark:text-secondary-light"
                                >
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          <div class="px-4 py-4 sm:px-5">
                                            ...
                                            <div class="mt-4 space-y-4">
                                            <form action="{{ route('update-training', $training->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                            ...
                            <td class="text-center">
                                ...
                                <form id="deleteform" onsubmit="return confirm('هل تريد حذف الفرقة التدريبية؟');" action="{{ route('destroy-training', $training->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
