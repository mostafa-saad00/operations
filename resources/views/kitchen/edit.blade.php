<x-app-layout>
    ...
    <form action="{{ route('update-kitchenitem', $kitchenitem->id) }}" method="post">
        @csrf
        @method('PUT')
                  ...
                  <span class="relative mt-1.5 flex">
                    ...
                    >
                      @foreach ($kitchensuppliers as $kitchensupplier)   
                        <option @if($kitchensupplier->id == $kitchenitem->kitchensupplier_id) selected @endif value="{{ $kitchensupplier->id }}">{{ $kitchensupplier->name }}</option>
                      @endforeach
                ...
                <label class="block">
                    ...
                    <span class="relative mt-1.5 flex">
                      ...
                      >
                        ...
                        <option @if($kitchenitem->unit == 'كيلو') selected @endif value="كيلو">كيلو</option>
                        <option @if($kitchenitem->unit == 'جرام') selected @endif value="جرام">جرام</option>
                        <option @if($kitchenitem->unit == 'علبة') selected @endif value="علبة">علبة</option>
                        <option @if($kitchenitem->unit == 'فتلة') selected @endif value="فتلة">فتلة</option>
                        <option @if($kitchenitem->unit == 'قطعة') selected @endif value="قطعة">قطعة</option>
                      </select>
              ...
              <label class="block">
                ...
                <span class="relative mt-1.5 flex">
                  <input name="current_quantity"
                      ...
                      step="any"
                      type="number"
                      value="{{ $kitchenitem->current_quantity }}"
                    />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="saturday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->saturday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="saturday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->saturday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="saturday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->saturday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="saturday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->saturday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="saturday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->saturday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="saturday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->saturday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="sunday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->sunday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="sunday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->sunday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="sunday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->sunday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="sunday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->sunday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="sunday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->sunday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="sunday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->sunday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="monday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->monday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="monday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->monday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="monday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->monday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="monday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->monday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="monday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->monday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="monday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->monday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="tuesday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->tuesday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="tuesday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->tuesday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="tuesday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->tuesday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="tuesday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->tuesday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="tuesday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->tuesday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="tuesday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->tuesday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="wednesday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->wednesday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="wednesday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->wednesday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="wednesday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->wednesday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="wednesday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->wednesday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="wednesday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->wednesday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="wednesday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->wednesday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="thursday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->thursday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="thursday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->thursday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="thursday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->thursday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="thursday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->thursday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="thursday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->thursday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="thursday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->thursday_summer_solider }}"
                                  />
                        ...
                        <label class="block">
                          ...
                          <span class="relative mt-1.5 flex">
                            <input name="friday_winter_officer"
                                ...
                                step="any"
                                type="number"
                                value="{{ $kitchenitem->friday_winter_officer }}"
                              />
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="friday_winter_amen"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->friday_winter_amen }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="friday_winter_solider"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->friday_winter_solider }}"
                                />
                          ...
                          <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              <input name="friday_summer_officer"
                                  ...
                                  step="any"
                                  type="number"
                                  value="{{ $kitchenitem->friday_summer_officer }}"
                                />
                          ...
                          <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="friday_summer_amen"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->friday_summer_amen }}"
                                  />
                            ...
                            <label class="block">
                              ...
                              <span class="relative mt-1.5 flex">
                                <input name="friday_summer_solider"
                                    ...
                                    step="any"
                                    type="number"
                                    value="{{ $kitchenitem->friday_summer_solider }}"
                                  />
